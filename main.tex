...
\institute{Block Chain Programming}
\date{2026}
...
\begin{frame}{Overview}
  ...
  \end{itemize}
  \vfill
  \footnotesize Each video is presented as a short overview plus its main concepts and 2 to 3 keywords.
\end{frame}
...
\begin{frame}{Video 1: From the Internet to the Blockchain}
  ...
  \begin{itemize}
    ...
    \item \textbf{1978}: Robert Kahn's TCP/IP let separate networks share one language, giving birth to the Internet.
  \end{itemize}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item Limited scalability: Bitcoin $\approx$3 to 4 TPS vs.\ Visa $>$1{,}700; high fees when busy.
      \end{itemize}
    \end{column}
...
% ---------------------------------------------------------------------------
\begin{frame}{Video 2: Real-World Adopters \& Applications}
  \footnotesize
  \textbf{Walmart \& Sam's Club: food traceability at enterprise scale}
  \begin{itemize}
    \item Sept 2018: leafy-greens suppliers must give real-time, end-to-end traceability from farm to store on a shared blockchain (built with IBM and 11 food companies; IBM Food Trust).
    \item Suppliers log digital traceability events; they need only a smart device and internet.
    \item Earlier pilots (2016) traced Chinese pork and fresh mangoes back to source.
  \end{itemize}
  \textbf{Practical impact}
  \begin{itemize}
    \item Store-to-farm tracing: from \alert{$\sim$7 days} to \alert{2.2 seconds}.
    \item Faster, precise recalls: isolate the affected lot, protect customers, cut waste and losses.
    \item Same pattern (a shared, permissioned ledger at enterprise scale) is this video's theme.
  \end{itemize}
  \textbf{Who else uses Hyperledger:} IBM Food Trust (Nestl\'e, Unilever); Maersk/IBM
  TradeLens (MSC, CMA CGM; retired 2022); Bank of Canada bond pilot; Besu: DTCC, Citi,
  Standard Chartered.
\end{frame}
